...
class TestAsync extends PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function test_async()
	{
		...
		$this->byXPath("//a/h3[contains(text(),'Async Execution')]")->click();
		...
		$this->byCssSelector("#runner-2 a")->click();
		...
		usleep(1500000);
		$this->stopRefresh();
		$amount = $this->byCssSelector("div#runner-2.panel.panel-default > div.panel-body > div.row > div.col-md-5.text-right > span");
		$result = $amount->text();
		...
		$result = $this->byCssSelector("div#runner-1.panel.panel-default > div.panel-body > div.row > div.col-md-5.text-right > span")->text();
		$this->assertEquals("$ 0.00", $result);
		$result = $this->byCssSelector("div#runner-3.panel.panel-default > div.panel-body > div.row > div.col-md-5.text-right > span")->text();
		$this->assertEquals("$ 0.00", $result);

		// Start all other runners

		$this->stopRefresh();
		$this->byCssSelector("div#runner-1.panel.panel-default > div.panel-body > div.row > div.col-md-1 > div.btn-group > a.btn.btn-success > span.glyphicon.glyphicon-play")->click();

		$this->stopRefresh();
		$this->byCssSelector("div#runner-3.panel.panel-default > div.panel-body > div.row > div.col-md-1 > div.btn-group > a.btn.btn-success > span.glyphicon.glyphicon-play")->click();
...
*/
		...
		*/
		...
		$val1 = $this->byCssSelector("div#runner-1.panel.panel-default > div.panel-body > div.row > div.col-md-5.text-right > span")->text();
		$val2 = $this->byCssSelector("div#runner-2.panel.panel-default > div.panel-body > div.row > div.col-md-5.text-right > span")->text();
		$val3 = $result = $this->byCssSelector("div#runner-3.panel.panel-default > div.panel-body > div.row > div.col-md-5.text-right > span")->text();
